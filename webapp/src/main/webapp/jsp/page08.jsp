            ...
            <thead>
              <tr>
                ...
                <td class="tg-0lax"> 최근 3개월 이내에 의사로부터 진찰 또는 검사를 통하여 다음과 같은 의료행위를 받은 사실이 있습니까?<br>질병확정진단, 질병의심소견, 치료, 입원, 수술(제왕절개포함), 투약
                    <br>
                    <input type="radio" class="a-radio" title="1년이내 질병 의료행위 예" value="0">
                    <a>예</a>
                    <input type="radio" class="a-radio" title="1년이내 질병 의료행위 아니오" value="1">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax">최근 3개월 이내에 마약을 사용하거나 혈압강하제, 각성제(흥분제), 신경안정제, 수면제, 진통제 등 약품을 상시 복용한 사실이 있습니까?
                    <br>
                    <input type="radio" class="b-radio" title="1년이내 질병 약품복용 예" value="10">
                        <a>예</a>
                    <input type="radio" class="b-radio" title="1년이내 질병 약품복용 아니오" value="11">
                        <a>아니오</a>
              ...
              <tr>
                <td class="tg-0lax">최근 1년 이내에 의사로 부터 진찰 또는 검사를 통하여 추가검사(재검사)를 받은 사실이 있습니까?
                    <br>
                    <input type="radio" class="c-radio" title="1년이내 질병 추가검사 예"  value="20">
                        <a>예</a>
                    <input type="radio" class="c-radio" title="1년이내 질병 추가검사 아니오" value="21">
                        <a>아니오</a>
                </td>
              </tr>
            </thead>
            ...
            <thead>
              <tr>
                ...
                <td class="tg-0lax">최근 5년 이내에 의사로부터 진찰 또는 검사를 통하여 다음과 같은 의료행위를 받은 사실이 있습니까?<br>입원, 수술(제왕절개포함), 계속하여 7일이상 치료, 30일 이상 투약
                    <br>
                    <input type="radio" class="d-radio" title="5년이내 질병 의료행위 예"  value="30">
                        <a>예</a>
                    <input type="radio" class="d-radio" title="5년이내 질병 의료행위 아니오" value="31">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax"> 최근 5년 이내에 10대질병으로 부터 진찰 또는 검사를 통하여 다음과 같은 의료행위를 받은 사실이 있습니까?<br>- 질병확정진단, 치료, 입원, 수술, 투약<br>- 10대질병 : 암, 백혈병, 고혈압, 협심증, 심근경색, 심장판막증, 간경화증, 뇌졸줄증(뇌출혈, 외경색), 당뇨병, 에이즈(AIDS) 및 HIV보균
                    <br>
                    <input type="radio" class="e-radio" title="5년이내 질병 10대질병 예"  value="40">
                        <a>예</a>
                    <input type="radio" class="e-radio" title="5년이내 질병 10대질병 아니오" value="41">
                        <a>아니오</a>
                </td>
              </tr>
            </thead>
            ...
            <thead>
              <tr>
                ...
                <td class="tg-0lax"> 이륜자동차(자동차관리법상 이륜차로 분류되는 삼륜 또는 사륜의 자동차를 포함)<br>또는 원동기 장치 자전거(전동킥보드, 전동이륜평행차, 전동기의 동력만으로 움직일 수 있는 자전거 등 개인형 이동장치를 포함)를 사용하십니까?<br>(다마느 전동휠체어, 의료용 스쿠터 등 보행보조용 의자차는 제외합니다.)
                    ...
                    <input type="radio" class="f-radio" title="기타 이륜차 예"  value="50">
                        <a>예</a>
                    <input type="radio" class="f-radio" title="기타 이륜차 아니오"  value="51">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax">최근 1년 이내에 다음과 같은 취미를 자주 반복적으로 하고 있거나 관련 자격증을 가지고 있습니까?<br>스쿠버다이빙 행글라이딩/패러글라이딩, 스카이다이빙, 수상스키, 자동차/오토바이 경주, 번지점프, 빙벽 암벽등반, 제트스키, 레프팅
                    <br>
                    <input type="radio" class="g-radio" title="기타 취미 예"  value="60">
                    <a>예</a>
                    <input type="radio" class="g-radio" title="기타 취미 아니오" value="61">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax"> 부업 또는 겸업, 계절적으로 종사하는 업무가 있습니까?
                    <br>
                    <input type="radio" class="h-radio" title="기타 계절 예" value="70">
                        <a>예</a>
                    <input type="radio" class="h-radio" title="기타 계절 아니오"  value="71">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax"> 향후 3개월 이내에 다름과 같은 해외 위험지역으로 출국할 예정이 있습니까?<br>전쟁지역, 미개척지(열대, 한대), 등반산악지대
                    <br>
                    <input type="radio" class="i-radio" title="기타 출국 예"  value="80">
                        <a>예</a>
                    <input type="radio" class="i-radio" title="기타 출국 아니오" value="81">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax"> 술을 드시나요?
                    <br>
                    <input type="radio" class="l-radio" title="술 예"  value="90">
                        <a>예</a>
                    <input type="radio" class="l-radio" title="술 아니오"  value="91">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax"> 담배를 피우시나요?
                    <br>
                    <input type="radio" class="m-radio" title="담배 예"  value="100">
                        <a>예</a>
                    <input type="radio" class="m-radio" title="담배 아니오" value="101">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
                <td class="tg-0lax">청약전 1년 이내에 담배를 피우신 적이 있습니까?
                    <br>
                    <input type="radio" class="n-radio" title="1년이내 담배 예"  value="110">
                        <a>예</a>
                    <input type="radio" class="n-radio" title="1년이내 담배 아니오" value="111">
                        <a>아니오</a>
                </td>
              </tr>
              <tr>
